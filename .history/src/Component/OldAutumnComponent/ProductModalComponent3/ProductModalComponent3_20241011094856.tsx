						...
						<div className='productModal3-rightColumn'>
							<Form layout='vertical' onFinish={handleSubmit}>
								<Form.Item label='Máy đang dùng'>
									<input className='productModal3-input' defaultValue={ProductUse?.item.name} disabled />
								</Form.Item>
								<Form.Item label='Tình trạng'>
									<input defaultValue={tinhtrangmay} disabled className='productModal3-statusInput productModal3-input' />
								</Form.Item>
