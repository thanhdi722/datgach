...
import { Modal, Spin, Form, Checkbox } from 'antd';
			...
			<Context.Provider value={contextValue}>
				...
				<Modal visible={visible} onCancel={onCancel} footer={null} centered>
					...
					<Form layout='vertical' onFinish={handleOk}>
						...
						>
							<input className='ModalInfoOldAutumn-input' placeholder='Nhập họ tên' />
						</Form.Item>
						<div style={{ display: 'flex', gap: '10px', width: '100%' }}>
							<Form.Item
								...
								style={{ width: '100%' }}
							>
								<input className='ModalInfoOldAutumn-input' placeholder='Nhập số điện thoại' />
							</Form.Item>
							...
							<Form.Item
								...
								style={{ width: '100%' }}
							>
								<input className='ModalInfoOldAutumn-input' placeholder='Nhập email' />
							</Form.Item>
						</div>
						...
						>
							<input className='ModalInfoOldAutumn-input' placeholder='Nhập quận/huyện, tỉnh thành' />
						</Form.Item>
						...
						>
							<input className='ModalInfoOldAutumn-input' placeholder='Nhập tên máy, loại máy' />
						</Form.Item>
						...
						>
							<input className='ModalInfoOldAutumn-input' placeholder='Mô tả' />
						</Form.Item>
