...
const ProductModal1: React.FC<ProductModalProps> = ({
	...
	const phoneConditionDescriptions: { [key: string]: string } = {
		warranty_mobile: '[Loại 1] Máy hoạt động bình thường, Full chức năng, màn đẹp, thân máy đẹp.',
		warranty_scratch_light: '[Loại 2] Máy hoạt động bình thường, màn đẹp, thân máy trầy xước nhẹ.',
		normal: '[Loại 3] Máy hoạt động bình thường, màn trầy nhẹ, thân máy cấn móp nhẹ.',
	};
					...
					<div className='BodyOldAutumn-container'>
						<div className='BodyOldAutumnM1-left-section'>
							<Image
								...
								height={400}
							/>
							<p style={{padding:""}}>{selectedProduct.item.name}</p>
						</div>
