...
const PriceList: React.FC = () => {
  return (
    <div style={{ backgroundColor: '#1d1d1f' }}>
      <Image src={newChangeImageMb} alt="Exclusive Offers" className={styles.imageWrapperMB} />
      <Image src={newChangeImage} alt="Exclusive Offers" className={styles.imageWrapper} />
