...
export default function FormMain() {
  ...
  console.log('selectedProduct', products[selectedProduct])
  ...
  const handleStorageChange = (storage: string) => {
    ...
    console.log('check storage', products[selectedProduct]?.storageOptions[selectedStorage])
  }
  const handleColorsChange = (color: string) => {
    setSelectedColor(color)
    console.log(
      'check giá color',
      products[selectedProduct]?.storageOptions[selectedStorage]?.[selectedColor]?.price?.toLocaleString()
    )
    console.log('check color', products[selectedProduct].colorOptions[color])
    console.log('cnheck pic', products[selectedProduct].colorOptions[selectedColor].img)
  }
  ...
  return (
    <div id="registerForm" style={{ backgroundColor: '#1d1d1f', padding: '10px 0' }}>
      <Spin spinning={spinning} percent={percent} fullscreen />
      <p className="comboText">Sở hữu siêu phẩm iPhone 16 Series tại Bạch Long Mobile AAR</p>
            ...
            <div className="product">
              ...
              >
                ...
                >
                  <Image
                    alt={selectedProduct}
                    src={products[selectedProduct].colorOptions[selectedColor].img}
                    width={200}
                    height={200}
                  />
                </Box>
                        ...
                        <Button
                          sx={{
                            ...
                            '&:hover': {
                              ...
                              backgroundColor: selectedColor === product ? '#fff' : '#fff',
                            },
                          }}
                          key={product}
                ...
                <Box sx={{ display: 'flex', flexDirection: 'row', marginTop: 2 }}>
                  <Grid container spacing={2}>
                    {Object.keys(products[selectedProduct].storageOptions).map((storage, index) => (
                      <Grid item key={index}>
                        <Button
                          sx={{
                            background:
                            ...
                            '&:hover': {
                              ...
                              backgroundColor: selectedColor === storage ? '#fff' : '#fff',
                            },
                          }}
                          key={storage}
                ...
                <Box sx={{ display: 'flex', flexDirection: 'row', marginTop: 2 }}>
                  <Grid container>
                    ...
                    >
                      {Object.keys(products[selectedProduct].colorOptions).map((color, index) => (
                        <Grid
                          item
                          key={index}
                          sx={{
                            ...
                            control={
                              ...
                              >
                                <Radio
                                  ...
                                  sx={{
                                    marginLeft: 2,
                                    color: products[selectedProduct].colorOptions[color].codeColor,
                                    '&.Mui-checked': {
                                      color: products[selectedProduct].colorOptions[color].codeColor,
                                    },
                                  }}
                ...
                <Box>
                  <Typography sx={{ color: '#fff', fontWeight: 40, fontSize: 20 }}>
                    Giá dự kiến:{' '}
                  ...
                  <Typography sx={{ color: '#fff', fontWeight: 20 }}>
                    ...
                    <span>
                      {Math.floor(
                        products[selectedProduct]?.storageOptions[selectedStorage]?.[selectedColor]?.price /
                          12
                      ).toLocaleString()}
                      đ / tháng
                    </span>
                ...
                >
                  <li className="form-list-row">
                    <div className="user">
                      ...
                      <br />
                      <i className="fas fa-user" style={{ color: 'white', fontSize: 20 }} />
                      <input
                        type="text"
                        value={name}
                  ...
                  <li className="form-list-row">
                    <div className="number">
                      ...
                      <br />
                      <i className="far fa-address-book	" style={{ color: 'white', fontSize: 20 }} />
                      <input
                        type="tel"
                        value={phone}
                        onChange={(e) => {
                  ...
                  <li className="form-list-row clearfix">
                    <div className="number">
                      ...
                      <br />
                      <i className="far fa-credit-card" style={{ fontSize: '1.6rem' }} />
                      <input
                        type="email"
                        value={email}
      ...
      <div className="modal-MB" style={{ backgroundColor: '#1d1d1f' }}>
        ...
        >
          <Grid container style={{ height: '170px', marginBottom: 20 }}>
            <Grid
              item
              sm={6}
              style={{
            ...
            <Grid item sm={6}>
              <Box sx={{ marginTop: 5 }}>
                ...
                <Typography className="textGia_MB">
                  Trả góp chỉ từ: <span>{products[selectedProduct].installment}</span>
                </Typography>
              </Box>
            </Grid>
          </Grid>
              ...
              {Object.keys(products).map((product, index) => (
                <Grid key={index} item style={{ marginTop: '-8px' }}>
                  <Button
                    sx={{
                      background:
                        selectedProduct === product ? 'linear-gradient(90deg, #d09e7b, #f3eae6)' : '#ffff',
                      color: '#000',
                      marginRight: '10px',
                      borderRadius: '22px',
                      width: '122px',
              ...
              {Object.keys(products[selectedProduct].storageOptions).map((storage, index) => (
                <Grid item key={index}>
                  <Button
                    sx={{
                      background:
                        selectedStorage === storage ? 'linear-gradient(90deg, #d09e7b, #f3eae6)' : '#ffff',
                      color: '#000',
                      marginRight: '3px',
                      borderRadius: '22px',
                      fontSize: 12,
