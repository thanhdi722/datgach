	...
	useEffect(() => {
		setFilteredData(
			(Access20k || [])
				.filter(
					(product) =>
						product.name.startsWith('iPhone 14') &&
						!product.name.includes('iPhone 14 Pro Max') &&
						!product.name.includes('iPhone 14 Plus') &&
						!product.name.includes('iPhone 14 Pro')
				)
				.sort(
					(a, b) =>
