	...
	useEffect(() => {
		setFilteredData(
			(Access20k || [])
				.filter(
					(product) =>
						product.name.startsWith('iPhone 15') &&
						!product.name.includes('iPhone 15 Pro Max') &&
						!product.name.includes('iPhone 15 Plus') &&
						!product.name.includes('iPhone 15 Pro')
				)
				.sort(
					(a, b) =>
