...
import ProductModal4 from "../ProductModalComponent4/ProductModalComponent4";
...
const ProductModal3: React.FC<ProductModalProps> = ({
  ...
  return (
    <>
          ...
          <div className="productModal3-rightColumn">
            <Form layout="vertical" onFinish={handleSubmit}>
              <Form.Item label="Máy đang dùng">
                <input
                  className="productModal3-input"
                  defaultValue={ProductUse?.item.name}
                  disabled
                />
              </Form.Item>
              <Form.Item label="Tình trạng">
                <input
                  defaultValue={tinhtrangmay}
                  disabled
                  className="productModal3-statusInput"
                />
              </Form.Item>
              <Form.Item label="Lưu ý">
                <div className="productModal3-note">
                  Để biết giá thu cũ thể vui lòng mang máy đến cửa hàng để được
      ...
      <ProductModal4
        modalOpen={isModal4Open}
        ProductUse={ProductUse}
        selectedProduct={selectedProduct}
        onCancelModal={() => setIsModal4Open(false)}
